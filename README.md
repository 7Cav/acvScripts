# acvScripts
<p align="left">
<a href="https://github.com/7Cav/acvScripts/releases/latest"><img src="https://img.shields.io/github/release/7Cav/acvScripts.svg?style=plastic&label=Release%20Build" alt="Release Build Version"></a>
 <a href="https://github.com/7Cav/acvScripts/releases/latest"><img src="https://img.shields.io/github/release/7Cav/acvScripts/all.svg?style=plastic&label=Pre-release" alt="Pre release and or current build version"></a>
 <a href="https://github.com/7Cav/acvScripts/tree/master"><img src="https://img.shields.io/badge/Dev Build-v3.1.7-brightgreen.svg?style=plastic" alt="Development Build Version"></a>
 <a href="https://github.com/7Cav/acvScripts/issues"><img src="https://img.shields.io/github/issues-raw/7cav/acvScripts.svg?style=plastic&label=Issues" alt="acvScripts Issues"></a>
 <a href="https://github.com/7Cav/acvScripts/releases"><img src="https://img.shields.io/github/downloads/7cav/acvScripts/total.svg?style=plastic&label=Downloads" alt="acvScripts Downloads"></a>
</p>
This is acvScripts a easy to use framework for the Arma3 S3 Battlestaff and other mission makers. This framework contain functions, scripts that is easy to use and implement on a new mission. All scripts and functions are adaptatied to 7CAV mission standard.
...
## Installation
In order to install this script package you only need to [download](https://github.com/7Cav/acvScripts/releases/latest) it and place the content in your mission folder located:
...
## What do acvScripts provide?
acvScripts provides you with the basic for S3 Operation making.
...
### AI Tweek (init.sqf)
The AI in acvScripts `init.sqf` have been changed to be a little more realistic and to avoid them being rediculus. The recomended default setting is the one probided and it have been carfully tested and seam to be the best.
...
acvScripts core function are [Poppy](https://github.com/BaerMitUmlaut/Poppy) a reliable, self configuring, error finding loadout framework made by [BaerMitUmlaut](https://github.com/BaerMitUmlaut). The script automaticly give ___all blufor players___ a pre defined loadout in the list below. If you havea un recugnice loadout you will be given the default loadout (CommonBlufor).
...
If you want to disable or change the loadouts you can find them here: `acvScripts\CfgLoadouts.hpp`, `acvScripts\Loadouts\*.hpp`

## CfgSettings
acvScripts have settings to make stuff easier to use and customizable. All settings can be found here: `CfgSettings.hpp`. Below are each settings avalible and a description on what they do.
...
``` c++
 ...
 Example:
 [this] call acvScripts_fnc_doStarterCrate;
 [this,"none",true] call acvScripts_fnc_doStarterCrate;
 [this,"none",true,true,true,1] call acvScripts_fnc_doStarterCrate;
```

#### acvScripts_fnc_initVehicle
...
#### acvScripts_fnc_attachVehicleLabel
``` c++
 ...
 Example:
 [this] call acvScripts_fnc_attachVehicleLabel;
 [this,"B1"] call acvScripts_fnc_attachVehicleLabel;
```

#### acvScripts_fnc_doSupplyCrate
``` c++
 ...
 Example:
 [this,0.5] call acvScripts_fnc_doSupplyCrate;
 [this,1] call acvScripts_fnc_doSupplyCrate;
```

**Note:** *There are specialized crates as well: `acvScripts_fnc_doAmmoCrate`, `acvScripts_fnc_doLaunchersCrate`, `acvScripts_fnc_doGrenadesCrate`, `acvScripts_fnc_doExplosivesCrate` you can read more about them in the [Function Viewer](https://community.bistudio.com/wiki/Functions_Library_(Arma_3)#Finding_a_Function) under the supplies category. You can find additional ones there as well.*
...
``` c++
 ...
 Example:
 [this] call acvScripts_fnc_flag;
 [this,"yellow"] call acvScripts_fnc_flag;
```
