 ...
 *
 * Example:
 * call acvScripts_fnc_Doc_MissionControl;
 */
...
<br/><br/>
        <font color='#ffc61a'>Add starter crate actions and inventory:</font><br/>
                [_this select 1] call acvScripts_fnc_doStarterCrate;<br/>
                ...
                [_this select 1,'none',true,true,true,1] call acvScripts_fnc_doStarterCrate;<br/>
<br/>
        <font color='#ffc61a'>Set a flag to the 7th Cavalry garry owen texture:</font><br/>
                [_this select 1] call acvScripts_fnc_flag;<br/>
<br/>
        <font color='#ffc61a'>Set UH-60 tail number (currently only b1 to b5 available):</font><br/>
                [_this select 1,'b1'] call acvScripts_fnc_UH60TailNumber;</p>
        "
    ]
];
