 ...
 *
 * Example:
 *  call acvScripts_fnc_initCustomStartHint;
 *  ["My mission", "Description text.", 10] call acvScripts_initCustomStartHint;
 */
...
_image  = "<img size='5' image='acvScripts\Data\Images\7CAV_LOGO_01.paa' align='center'/><br /><br />";
