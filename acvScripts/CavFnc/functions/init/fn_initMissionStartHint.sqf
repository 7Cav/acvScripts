 ...
 *
 * Example:
 *  call acvScripts_fnc_initMissionStartHint;
 *  [60] call acvScripts_fnc_initMissionStartHint;
 */
...
_image0  = "<img size='5' image='acvScripts\Data\Images\7CAV_LOGO_01.paa' align='center'/><br /><br />";
_image1  = "<br /><br /><img size='5' image='acvScripts\Data\Images\7CAV_LOGO_00.paa' align='center'/><br /><br />";
