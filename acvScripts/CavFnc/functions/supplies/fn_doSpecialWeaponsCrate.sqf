 ...
 *
 * Example:
 * [this,0.5] call acvScripts_fnc_doSpecialWeaponsCrate;
 * [this,1] call acvScripts_fnc_doSpecialWeaponsCrate;
 */
...
if (typeOf _crate in _crateType) then {
    _crate setObjectTextureGlobal  [0, "acvScripts\Data\Objects\Ammobox_7CAV_00.paa"];
};