 ...
 *
 * Example:
 * [this] call acvScripts_fnc_addArsenal
 */
...
// Make aceInteraction
private _Icon = "acvScripts\Data\Icon\icon_01.paa";
private _arsenalCondition = {true};
private _arsenalStatement = {["Open",true] spawn BIS_fnc_arsenal;};
private _arsenalAction = ["acvScriptsArsenalAce", "Arsenal", _Icon, _arsenalStatement, _arsenalCondition] call ace_interact_menu_fnc_createAction;
