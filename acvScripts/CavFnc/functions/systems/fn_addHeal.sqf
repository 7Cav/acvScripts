 ...
 *
 * Example:
 * [this] call acvScripts_fnc_addHeal;
 */
...
private _reHealAction = ["acvScriptsHealAce", "Heal", _Icon, _reHealStatement, _reHealCondition] call ace_interact_menu_fnc_createAction;
